...
export default async function PloegPage({ params }: Props) {
  ...
  // Origineel formaat ~2048×1818 — geen gedwongen hoogte/crop zodat de volledige foto zichtbaar is
  const photoSrc = team.teamPhoto?.asset
    ? urlFor(team.teamPhoto as Parameters<typeof urlFor>[0]).width(900).url()
    : null;
  ...
  return (
    <>
      ...
      <section className="bg-gray-900 text-white overflow-hidden">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 lg:py-28 flex flex-col gap-4">
          {team.categorie && (
          ...
          <aside className="space-y-6">
            ...
            <div className="rounded-lg overflow-hidden bg-gray-100">
              {photoSrc ? (
                ...
                /* Placeholder — zelfde stijl als ploegenoverzicht */
