...
export default async function HomePage() {
  ...
  const [events, posts] = await Promise.all([
    client.fetch<EventCardProps[]>(HOMEPAGE_EVENTS_QUERY, { now }, { next: { revalidate: 60 } }),
    client.fetch<NewsCardProps[]>(HOMEPAGE_POSTS_QUERY,   {},     { next: { revalidate: 300 } }),
  ]);
  ...
  return (
    <>
      ...
      <section className="relative bg-gray-900 text-white overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-28 lg:py-44 flex flex-col lg:flex-row items-start gap-12 lg:gap-20">
          {/* Linker kolom: tekst */}
      ...
      <section className="bg-white py-16 lg:py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {posts && posts.length > 0 ? (
            ...
            <div className="py-16 flex flex-col items-center gap-4 text-center border-2 border-dashed border-gray-200 rounded-lg">
              <svg
              ...
              <div className="space-y-1">
                <p className="text-gray-700 font-black uppercase tracking-tight">
                  Nog geen nieuwsberichten
                </p>
                <p className="text-gray-400 text-sm">
                  Kom later terug voor het laatste nieuws van Avanti Brugge Dames.
                </p>
              </div>
            </div>
          )}
