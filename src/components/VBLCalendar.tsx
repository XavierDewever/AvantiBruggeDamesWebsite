...
type Props = {
  ...
  /** Toon enkel komende wedstrijden; verberg gespeelde wedstrijden. */
  upcomingOnly?: boolean;
};

export default function VBLCalendar({ calendar, highlightTeam, upcomingOnly = false }: Props) {
  const { upcoming, past } = calendar;
  const showPast = !upcomingOnly && past.length > 0;
